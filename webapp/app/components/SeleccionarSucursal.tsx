...
class SeleccionarSucursal extends Component<SeleccionarSucursalProps, SeleccionarSucursalState> {
  constructor(props) {
    super(props);
    this.state = {
      sucursales: [],
...
type SeleccionarSucursalProps = StateProps & DispatchProps;

interface SeleccionarSucursalState {
